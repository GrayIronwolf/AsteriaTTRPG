...
check('Class overview absorbs class information', codexCompendiumJs.includes("['Class Name',entry.title]") && codexCompendiumJs.includes("['Starting Equipment',entry.starting_equipment.join(', ')"));
