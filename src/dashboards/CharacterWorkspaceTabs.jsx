...
export function PartyTab({ campaignId, character, characters, partyWorkspace, messages, editable }) {
  const [message,setMessage]=useState('');const [notes,setNotes]=useState(partyWorkspace.sharedNotes||'');const action=useAction();
