...
export const firebaseService = {
  ...
  createItemOffer: (campaignId, characterId, recipientId, itemId, mode, details) => requireMethod('createLiveItemOffer')(campaignId, characterId, recipientId, itemId, mode, details),
  respondItemOffer: (campaignId, characterId, offerId, accepted, details) => requireMethod('respondLiveItemOffer')(campaignId, characterId, offerId, accepted, details),
